...
from .S3_asset_cfg import S3_12DOF_CFG, S3_12DOF_JOINT_LOWER_ORDER, S3_12DOF_FIX_BASE_CFG, S3_22DOF_JOINT_ORDER, S3_22DOF_CFG, S3_12DOF_JOINT_UPPER_ORDER, S3_22DOF_FIX_JOINTLIMIT_CFG
from isaaclab.terrains.config.rough import ROUGH_TERRAINS_CFG
from dataclasses import MISSING
from .S3_env_cfg import S3RoughObsCfg, S3RoughRewards, S3RoughEventCfg, S3RoughSceneCfg, S3RoughEnvCfg, S3RoughCurriculumCfg


@configclass
class S3RoughNoGaitObsCfg:
    @configclass
...
@configclass
class S3RoughNoGaitRewards(S3RoughRewards):
    gait_rew = None
    gait_rew_ensure = None
    
@configclass
class S3RoughNoGaitEnvCfg(S3RoughEnvCfg):
    observations: S3RoughNoGaitObsCfg = S3RoughNoGaitObsCfg()
    rewards: S3RoughNoGaitRewards = S3RoughNoGaitRewards()
    
    def __post_init__(self):
        super().__post_init__()

@configclass
class S3FlatNoGaitEnvCfg(S3RoughNoGaitEnvCfg):
    def __post_init__(self):
        # post init of parent
        super().__post_init__()
