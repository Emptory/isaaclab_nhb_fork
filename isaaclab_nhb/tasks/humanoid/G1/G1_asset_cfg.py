...
G1_29DOF_CFG = ArticulationCfg(
    spawn=sim_utils.UsdFileCfg(
        # usd_path=f"{ISAACLAB_ROBOT_DESCRIPTION_PATH}/G1/usd/G1_29dof_box_cylinder/G1_29dof_box_cylinder.usd",
        # usd_path=f"{ISAACLAB_ROBOT_DESCRIPTION_PATH}/G1/usd/G1_29dof_mesh_foot/G1_29dof_mesh_foot.usd",
        # 全box碰撞，脚掌为box
        usd_path=f"{ISAACLAB_ROBOT_DESCRIPTION_PATH}/G1/usd/G1_29dof_full_collision/G1_29dof_full_collision.usd",
        # usd_path=f"{ISAACLAB_ROBOT_DESCRIPTION_PATH}/G1/usd/G1_29dof_full_collision_big_foot/G1_29dof_full_collision_big_foot.usd",
...
G1_12DOF_CFG = ArticulationCfg(
    spawn=sim_utils.UsdFileCfg(
        # 脚掌为一个box
        usd_path=f"{ISAACLAB_ROBOT_DESCRIPTION_PATH}/G1/usd/G1_12dof_box/G1_12dof_box.usd", 
        # 脚掌为box加圆柱
        # usd_path=f"{ISAACLAB_ROBOT_DESCRIPTION_PATH}/G1/usd/G1_12dof_box_cylinder/G1_12dof_box_cylinder.usd", 
        # 脚掌为mesh
        # usd_path=f"{ISAACLAB_ROBOT_DESCRIPTION_PATH}/G1/usd/G1_12dof/G1_12dof.usd",  
        activate_contact_sensors=True,
        rigid_props=sim_utils.RigidBodyPropertiesCfg(
            disable_gravity=False,
            retain_accelerations=False,
...
for a in G1_12DOF_CFG.actuators.values():
    e = a.effort_limit_sim
    s = a.stiffness
    names = a.joint_names_expr
    if not isinstance(e, dict):
    ...
    for n in names:
        if n in e and n in s and s[n]:
            G1_12DOF_ACTION_SCALE[n] = 0.25 * e[n] / s[n]